...
class Config:
    ...
    def arguments_parser(cls) -> ArgumentParser:
        ...
        parser.add_argument(
            ...
            "--save_word2v",
            dest="save_w2v",
            help="path to save the tokens embeddings file",
            metavar="FILE",
            required=False,
        )
        parser.add_argument(
            ...
            "--save_target2v",
            dest="save_t2v",
            help="path to save the targets embeddings file",
            metavar="FILE",
            required=False,
        )
        parser.add_argument(
        ...
        parser.add_argument(
            '-tsc',
            '--target_source_code',
            dest='target_source_code',
            default='Input.java',
            required=False,
        )
        parser.add_argument(
            '-tsceo',
            '--target_source_code_embeddings_output',
            dest='target_source_code_embeddings_output',
            default='vectors.txt',
            required=False,
        )
        return parser
